...
function init() {
	...
	spot.add( params.spot, 'helper' ).onChange( value =>{
		...
		if ( lights.spotHelper ) lights.spotHelper.visible = value;
	...
	area.close();
	area.add( params.area, 'enable' ).onChange( value => {

		lights.area.visible = value;
	...
	area.add( params.area, 'helper' ).onChange( value => {

		if ( lights.areaHelper ) lights.areaHelper.visible = value;
	...
	directional.close();
	directional.add( params.directional, 'enable' ).onChange( value => {
	...
	directional.add( params.directional, 'helper' ).onChange( value => {

		if ( lights.directionalHelper ) lights.directionalHelper.visible = value;
	...
	point.close();
	point.add( params.point, 'enable' ).onChange( value => {
	...
	point.add( params.point, 'helper' ).onChange( value => {

		if ( lights.pointHelper ) lights.pointHelper.visible = value;
...
function update() {
	...
	if ( params.directional.moving ) {
		...
		if ( lights.directionalHelper ) lights.directionalHelper.update();
