class MyShaderChunks{
	static lights_gouraud_vertex = `
	...
	#endif
	`
	static simple_lambert_vertex_v155 = `
vec3 vLightFront, vLightBack, vIndirectFront;
#include <uv_vertex>
...
#include <project_vertex>
  //inlining lights lambert vertex
  vec3 diffuse = vec3( 1.0 );
